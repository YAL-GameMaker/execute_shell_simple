...
set extName=execute_shell_simple_ext
set dllName=execute_shell_simple_ext
set gmlDir14=%solutionDir%execute_shell_simple_ext.gmx
set gmlDir22=%solutionDir%execute_shell_simple_ext_yy
set gmlDir23=%solutionDir%execute_shell_simple_ext_23
